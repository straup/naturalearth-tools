...
# Yes, those URLs look super weird. Because they are.
# But they work.

# Packages are also available in a single bundle here:
# http://www.nacis.org/naturalearth/packages/natural_earth_vector.zip
